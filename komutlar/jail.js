...
module.exports.run = async(client,message,args) => {
    ...
    let oziemb = new Discord.MessageEmbed()
        ...
        .setFooter("Kudi", executor.user.displayAvatarURL({dynamic: true}))
        .setTimestamp()


        //Gerekli idler buraya
        let cezarolu = osettings.jailhammer || "848667879025147914" // id girilecek buraya da :) eğer proje benim projem değilse
        let boosterrolu = osettings.boosterrolu || "852935161942114325" // Proje hazır değilse id gelicek .)
        let jailrolu = osettings.jailrolu || "848684100105535518" // Buraya da aynı şekilde 
